...
class Chaser(QuidditchPlayer):
    ...
    def energy(self, time):
        ...
        "*** YOUR CODE HERE ***"
        if not time % 9 == 0:
            self.base_energy -= (self.energy_expended*self.goals)
            return self.base_energy
        else:
            self.base_energy = (self.base_energy - (self.energy_expended*self.goals)) - (self.energy_expended*(.1))
            return self.base_energy
...
class Seeker(QuidditchPlayer):
    ...
    def energy(self, time):
        ...
        """
        "*** YOUR CODE HERE ***"
        self.base_energy -= (time*self.energy_expended)
        return self.base_energy
...
class Keeper(QuidditchPlayer):
    ...
    def energy(self, time):
        ...
        if time < 30:
            ...
            num = time // 15
            self.base_energy -= (num *(self.energy_expended*.8))
            return self.base_energy
