...
class Arr88():
    ...
    def __add__(self, arr88):
        ...
        #return [self.item(i) + arr88.item(i) for i in range(len(self._values))]
        #return (self._values + arr88._values)
    ...
    def negate(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        self._values = [i*-1 for i in self._values]
    ...
    def apply(self, func):
        ...
        """
        "*** YOUR CODE HERE ***"
        return Arr88([func(i) for i in self._values])
...
class VendingMachine:
    ...
    def vend(self):
        ...
        if self.balance > self.price:
            self.stock -= 1
            cashback = self.balance - self.price
            self.balance -= self.price 
            self.balance -= cashback
            return 'Here is your candy and ${} change.'.format(cashback)
        if self.balance == self.price:
            self.stock -= 1
